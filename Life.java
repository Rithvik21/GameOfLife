...
class Life extends JFrame implements ActionListener
{
    ...
    private JButton runButton, pauseButton, resumeButton, resetButton, colorRandButton;
    LifeView l = new LifeView();
    ...
    Life(String fileName) throws IOException
    {
        ...
        colorRandButton = new JButton("Randomize Color");
        colorRandButton.addActionListener(this);
        colorRandButton.setEnabled(true);
        controlPanel.add(colorRandButton);
